...
with tab1:        
    ...
    insect = Organism('Insects', [acacia], 3, 50)
    bilby = Organism('Bilbies', [grass, insect], 3, 50)
    kangaroo = Organism('Kangaroos', [grass], 3, 50)
    snake = Organism('Snakes', [insect, bilby], 3, 50)
    eagle = Organism('Wedge-tailed Eagles', [snake, kangaroo], 3, 10)
